...
sidebar: sidebar 
keywords:  
summary: 您可以使用示例文件将四个Linux物理接口聚合到一个LACP绑定中、然后建立三个VLAN接口、将此绑定分包为StorageGRID 网格、管理和客户端网络接口。 
---
...
[role="lead"]
您可以使用示例文件将四个Linux物理接口聚合到一个LACP绑定中、然后建立三个VLAN接口、将此绑定分包为StorageGRID 网格、管理和客户端网络接口。
